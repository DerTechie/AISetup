...
> **Status:** Phase 1 (routing gateway) complete; Phase 2 (triage advisor) — script + judge verified live against the gateway; Hermes-side integration (deploy + skill triggering) pending. See the [design spec](docs/superpowers/specs/2026-05-20-hybrid-ai-routing-design.md) and the [decision journal](docs/journal/).
